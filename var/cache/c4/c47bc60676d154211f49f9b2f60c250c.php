...
";
        // line 3
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\DebugExtension::dump($this->env, $context, ...[($context["hobbies"] ?? null)]), "html", null, true);
        yield "
";
        yield from [];
    }
    ...
    {
        return new Source("<h1>Voici les derniers 20 hobbies :</h1>
