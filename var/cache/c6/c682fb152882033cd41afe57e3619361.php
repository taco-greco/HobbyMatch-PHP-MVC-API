...
class __TwigTemplate_700bdcd5aa3bd81bedfb88852bf533d7 extends Template
{
...
\t\t\t\t\t\t<a href=\"mailto:";
        ...
        yield "</a>
\t\t\t\t\t</p>
\t\t\t\t\t<a class=\"btn btn-outline-danger m-2\" href=\"/Hobby/pdf/";
        // line 37
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["hobby"] ?? null), "Id", [], "any", false, false, false, 37), "html", null, true);
        yield "\"><i class=\"bi bi-file-pdf-fill\"></i>PDF</a>
\t\t\t\t</div>
...
\t\t\t\t\t\t";
        // line 47
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["hobby"] ?? null), "description", [], "any", false, false, false, 47), "html", null, true);
        yield "</p>
...
fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=";
        // line 73
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["hobby"] ?? null), "Latitude", [], "any", false, false, false, 73), "html", null, true);
        yield "&lon=";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["hobby"] ?? null), "Longitude", [], "any", false, false, false, 73), "html", null, true);
...
";
    ...
    {
        return array (  200 => 73,  192 => 70,  179 => 62,  174 => 59,  167 => 58,  152 => 47,  139 => 37,  132 => 35,  126 => 32,  120 => 29,  114 => 26,  109 => 23,  102 => 21,  99 => 20,  97 => 19,  86 => 11,  82 => 9,  75 => 8,  68 => 6,  63 => 4,  60 => 3,  53 => 2,  42 => 1,);
    }
...
\t\t\t\t\t</p>
\t\t\t\t\t<a class=\"btn btn-outline-danger m-2\" href=\"/Hobby/pdf/{{hobby.Id}}\"><i class=\"bi bi-file-pdf-fill\"></i>PDF</a>
\t\t\t\t</div>
...
\t</script>
{% endblock %}
", "Hobby/show.html.twig", "C:\\wamp64\\www\\hobbymatch\\src\\View\\Hobby\\show.html.twig");
    }
}
